...
func CategoryDo() {
	...
	//索引的名称
	indexName := "movie_category"
	//redis的key
	redisKey := "synch_es_category"
	...
	//创建movie的index
	es.CheckIndex(indexName, es.MappingMovieCategory)

	//计算总记录数
	ma := new(models.MovieCategory)
