...
func DirectorDo() {
	...
	//索引的名称
	indexName := "movie_director"
	//redis的key
	redisKey := "synch_es_director"
	...
	//创建movie的index
	es.CheckIndex(indexName, es.MappingMovieDirector)

	//计算总记录数
	ma := new(models.MovieDirector)
